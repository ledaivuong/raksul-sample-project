...
Feature: The Raksul Sample
  ...
  @invalidEmail
  Scenario: Check invalid email validation
    Given I am on the page test
  ...
  @emptyEmail
  Scenario: Check empty validation for email
    Given I am on the page test
    When I click on submit button
  ...
  @emptyInfoSource
  Scenario: Check empty validation for infoSource
    Given I am on the page test
    When I click on submit button
  ...
  @emptyAssociation
  Scenario: Check empty validation for Association
    Given I am on the page test
    When I click on submit button
  ...
  Scenario: Check empty validation for Interest Services
    Given I am on the page test
    When I click on submit button
